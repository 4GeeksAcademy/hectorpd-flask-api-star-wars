...
class StarShips(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, unique=True)
    model = db.Column(String(20), unique=False, nullable=True)
    starship_class = db.Column(String(20), unique=False, nullable=True)
    manufacturer = db.Column(String(20), unique=False, nullable=True)
    cost_in_credits = db.Column(Integer, unique=False, nullable=True)
    crew = db.Column(Integer, unique=False, nullable=True)
    passengers = db.Column(Integer, unique=False, nullable=True)
    max_atmosphering_speed = db.Column(Integer, unique=False, nullable=True)
    hyperdrive_rating = db.Column(Integer, unique=False, nullable=True)
    cargo_capacity = db.Column(Integer, unique=False, nullable=True)
    consumables = db.Column(String(20), unique=False, nullable=True)
    pilots = db.Column(String(20), unique=False, nullable=True)
    name = db.Column(String(20), unique=False, nullable=True)
